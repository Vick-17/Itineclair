...
final class SpaCsrfTokenRequestHandler
    ...
    private final CsrfTokenRequestHandler plainHandler =
            new CsrfTokenRequestAttributeHandler();

    private final CsrfTokenRequestHandler xorHandler;

    SpaCsrfTokenRequestHandler() {
        XorCsrfTokenRequestAttributeHandler handler =
                new XorCsrfTokenRequestAttributeHandler();

        handler.setCsrfRequestAttributeName(null);
        this.xorHandler = handler;
    }
    ...
    public String resolveCsrfTokenValue(
        ...
        return handler.resolveCsrfTokenValue(
                request,
                csrfToken);
    }
}
